...
EXCEL_ACHIEVEMENT_TYPE_TEMPLATES = [
    {
        "name": "论文成果",
        "fields": [
            {"key": "title", "label": "论文篇名"},
            {"key": "journal", "label": "刊物名称"},
            {"key": "publish_date", "label": "发表时间 (年/月/日)"},
            {"key": "journal_type", "label": "(勾选) CSSCI/Q1/Q2/Q3/Q4/报刊/普刊/本院集刊"},
            {"key": "level", "label": "(勾选) A1/A2/B/C/D/无"},
            {"key": "first_org", "label": "第一署名单位"},
            {"key": "is_first_org_ccnu_or_econ", "label": "(勾选) 是否为华中师范大学或华中师范大学经济与工商管理学院：是/否"},
            {"key": "is_teacher", "label": "(勾选) 是否本院教师：是/否"},
            {"key": "is_in_library", "label": "(勾选) 是否本院在库：是/否"},
            {"key": "first_author", "label": "第一作者姓名"},
            {"key": "second_author", "label": "第二作者姓名"},
            {"key": "third_author", "label": "第三作者姓名"},
            {"key": "fourth_author", "label": "第四作者姓名"},
            {"key": "support_material_desc", "label": "支撑材料说明 (提示: 格式要求: 文章实名页及全文+中科院检索分区)"}
        ]
    },
    {
        "name": "科研项目",
        "fields": [
            ...
            {"key": "project_type", "label": "(勾选) 华中师范大学研究生教育创新资助项目/由学校职能部门发布的其他科研项目"},
            {"key": "end_date", "label": "结项时间 (年/月/日)"},
            {"key": "project_lead", "label": "项目主持人姓名"},
            {"key": "team_member_1", "label": "项目成员1姓名"},
            {"key": "team_member_2", "label": "项目成员2姓名"},
            {"key": "team_member_3", "label": "项目成员3姓名"},
            {"key": "team_member_4", "label": "项目成员4姓名"},
            {"key": "team_member_5", "label": "项目成员5姓名"},
            {"key": "support_material_desc", "label": "文档材料说明"}
        ]
    },
    {
        "name": "专著成果",
        "fields": [
            {"key": "report_name", "label": "报告篇名"},
            {"key": "adopt_org", "label": "采纳单位/批示领导"},
            {"key": "adopt_date", "label": "采纳/批示时间 (年/月/日)"},
            {"key": "level", "label": "(勾选) A1/A2/B/C1/C2/D/A类不限/B1限2项/B2限2项/C1限2项/C2限2项/D先报2项/系个人每学期署名限3项社选达2分"},
            {"key": "first_org", "label": "第一署名单位"},
            {"key": "is_first_org_ccnu_or_econ", "label": "(勾选) 是否为华中师范大学或华中师范大学经济与工商管理学院：是/否"},
            {"key": "is_teacher", "label": "(勾选) 是否本院教师"},
            {"key": "first_author", "label": "第一作者姓名"},
            {"key": "second_author", "label": "第二作者姓名"},
            {"key": "third_author", "label": "第三作者姓名"},
            {"key": "fourth_author", "label": "第四作者姓名"},
            {"key": "support_material_desc", "label": "支撑材料说明 (提示: 涉密材料请申请线下审核)"},
            {"key": "is_offline_review_requested", "label": "(勾选) 是否申请线下审核：是/否"}
        ]
    },
    {
        "name": "著作",
        "fields": [
            ...
            {"key": "publish_date", "label": "出版时间 (年/月/日)"},
            {"key": "level", "label": "(勾选) A/B/C/D"},
            {"key": "is_editor", "label": "(勾选) 是否主编：是/否"},
            {"key": "word_count", "label": "字数规模"},
    ...
    },
    {
        "name": "参加学生工作",
        "fields": [
            {"key": "post_name", "label": "任职岗位/职务 (先填写) (勾选): 1.校团委副书记(学生) 2.学校、学院研究生会主席团成员... 3.学校、学院研究生会部门负责人... 4.党支部委员..."},
            {"key": "start_date", "label": "开始日期"},
            {"key": "end_date", "label": "结束日期"},
            {"key": "assessment_result", "label": "考核结果 (勾选): 1.优秀 2.合格 3.不合格 4.其他考核情况"},
            {"key": "support_material_desc", "label": "文档材料说明"},
    ...
    },
    {
        ...
        "fields": [
            ...
            {"key": "completion_level", "label": "认定分级 (勾选) A1类/A2类/B类/C类/省级"},
            {"key": "event_type", "label": "赛事类别 (勾选): 论文类/其他竞赛类"},
            {"key": "award_level", "label": "赛事级别 (勾选): 国家级/省级/校级/院级"},
            {"key": "award_name", "label": "等次 (勾选): 特等/一等/二等/三等/名次..."},
            {"key": "award_date", "label": "获奖时间"},
            {"key": "award_work_name", "label": "获奖作品名称"},
            {"key": "cooperation_type", "label": "合作类型 (勾选): 1.独作 2.多人合作-有 3.多人合作-无"},
            {"key": "first_author", "label": "第一作者姓名 (可不填)"},
            {"key": "second_author", "label": "第二作者姓名 (可不填)"},
            {"key": "third_author", "label": "第三作者姓名 (可不填)"},
            {"key": "support_material_desc", "label": "支撑材料说明"},
            {"key": "is_offline_review_requested", "label": "是否申请线下审核：是/否"}
        ]
    },
    {
        "name": "荣誉获奖",
        "fields": [
            {"key": "honor_name", "label": "荣誉名称 (先填写) (勾选): 1.\"五四青年奖章\"... 2.\"优秀共产党员\"..."},
            {"key": "level", "label": "级别 (勾选): 国家级/省级/校级/院级"},
            {"key": "award_date", "label": "获奖时间"},
            {"key": "support_material_desc", "label": "支撑材料说明"},
            {"key": "is_offline_review_requested", "label": "是否申请线下审核：是/否"}
        ]
    ...
    },
    {
        ...
        "fields": [
            ...
            {"key": "subjects", "label": "通过科目名称 (全部列出)"},
    ...
    },
    {
        "name": "参与活动",
        "fields": [
            {"key": "activity_type", "label": "活动类别 (勾选): 文艺体育类 (上限2分) / 学术发展类 (上限4分) / 社会实践类 (上限4分)"},
            {"key": "activity_name", "label": "活动名称"},
            {"key": "activity_duration", "label": "活动时长 (小时)"},
            {"key": "activity_count", "label": "活动次数 (次)"},
            {"key": "support_material_desc", "label": "支撑材料说明"},
            {"key": "is_offline_review_requested", "label": "是否申请线下审核：是/否"}
        ]
    },
    {
        "name": "减分",
        "fields": [
            {"key": "absence_count", "label": "无故缺课情况 (次)"},
            {"key": "leave_count", "label": "在校...请假 (次)"},
            {"key": "skip_count", "label": "在校...旷课 (次)"},
            {"key": "party_leave_count", "label": "学生党员...请假 (次)"},
            {"key": "party_skip_count", "label": "学生党员...旷课 (次)"},
            {"key": "support_material_desc", "label": "(后台提交学号+姓名+类别+次数 EXCEL上传匹配，自动编入)"}
        ]
    }
]
